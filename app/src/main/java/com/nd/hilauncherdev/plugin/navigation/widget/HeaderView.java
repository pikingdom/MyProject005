...
public class HeaderView extends LinearLayout{
	 ...
	 */
	private void init() {
		this.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, ScreenUtil.dip2px(getContext(), 48)));
...
//		this.setBackgroundResource(R.drawable.v7_common_header_bg);
		...
		mHead.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, ScreenUtil.dip2px(getContext(), 48)));
		mHead.setBackgroundResource(R.drawable.v7_common_header_bg);
		LinearLayout.LayoutParams lp = null;
		
		// 后退
		mGoBackLayout = new LinearLayout(mContext);
		lp = new LinearLayout.LayoutParams(ScreenUtil.dip2px(getContext(), MENU_LAYOUT_WIDTH), LayoutParams.MATCH_PARENT);
...
//		mMenuLayout.setBackgroundResource(R.drawable.common_menu_selector);
    ...
    public void replaceMenu(View view, boolean adjustMenuSize) {
        if(adjustMenuSize) {
            ViewGroup.LayoutParams lp = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
            mMenuLayout.setLayoutParams(lp);
            if (view == null) {
                return;
            }
